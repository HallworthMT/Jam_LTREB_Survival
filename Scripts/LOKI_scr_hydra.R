...
win.data <- readRDS("Data/LOKI_windata.rds")

Sst <- readRDS("Data/LOKI_Sst.rds")
z_start <- readRDS("Data/LOKI_z_start.rds")
...
saveRDS(M2,"LOKI_survival_streamline.rds")
saveRDS(M1,"LOKI_survival_streamline_coda.rds")
