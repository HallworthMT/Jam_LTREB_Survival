...
win.data <- readRDS("Data/GABU_windata.rds")

Sst <- readRDS("Data/GABU_Sst.rds")
z_start <- readRDS("Data/GABU_z_start.rds")
...
saveRDS(M2,"GABU_survival_streamline.rds")
saveRDS(M1,"GABU_survival_streamline_coda.rds")
