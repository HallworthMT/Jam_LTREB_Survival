...
win.data <- readRDS("Data/STOF_windata.rds")

Sst <- readRDS("Data/STOF_Sst.rds")
z_start <- readRDS("Data/STOF_z_start.rds")
...
saveRDS(M2,"STOF_survival_streamline.rds")
saveRDS(M1,"STOF_survival_streamline_coda.rds")
