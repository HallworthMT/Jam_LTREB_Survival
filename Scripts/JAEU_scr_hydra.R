...
win.data <- readRDS("Data/JAEU_windata.rds")

Sst <- readRDS("Data/JAEU_Sst.rds")
z_start <- readRDS("Data/JAEU_z_start.rds")
...
saveRDS(M2,"JAEU_survival_streamline.rds")
saveRDS(M1,"JAEU_survival_streamline_coda.rds")
