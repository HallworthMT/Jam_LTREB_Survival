...
win.data <- readRDS("Data/STFL_windata.rds")

Sst <- readRDS("Data/STFL_Sst.rds")
z_start <- readRDS("Data/STFL_z_start.rds")
...
saveRDS(M2,"STFL_survival_streamline.rds")
saveRDS(M1,"STFL_survival_streamline_coda.rds")
