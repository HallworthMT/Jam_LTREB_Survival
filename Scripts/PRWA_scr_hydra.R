...
win.data <- readRDS("Data/PRWA_windata.rds")

Sst <- readRDS("Data/PRWA_Sst.rds")
z_start <- readRDS("Data/PRWA_z_start.rds")
...
saveRDS(M2,"PRWA_survival_streamline.rds")
saveRDS(M1,"PRWA_survival_streamline_coda.rds")
