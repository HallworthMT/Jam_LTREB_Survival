...
win.data <- readRDS("Data/SWWA_windata.rds")

Sst <- readRDS("Data/SWWA_Sst.rds")
z_start <- readRDS("Data/SWWA_z_start.rds")
...
saveRDS(M2,"SWWA_survival_streamline.rds")
saveRDS(M1,"SWWA_survival_streamline_coda.rds")
