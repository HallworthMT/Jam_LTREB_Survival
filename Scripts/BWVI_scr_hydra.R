...
win.data <- readRDS("Data/BWVI_windata.rds")

Sst <- readRDS("Data/BWVI_Sst.rds")
z_start <- readRDS("Data/BWVI_z_start.rds")
...
saveRDS(M2,"BWVI_survival_streamline.rds")
saveRDS(M1,"BWVI_survival_streamline_coda.rds")
