...
win.data <- readRDS("Data/NOMO_windata.rds")

Sst <- readRDS("Data/NOMO_Sst.rds")
z_start <- readRDS("Data/NOMO_z_start.rds")
...
saveRDS(M2,"NOMO_survival_streamline.rds")
saveRDS(M1,"NOMO_survival_streamline_coda.rds")
