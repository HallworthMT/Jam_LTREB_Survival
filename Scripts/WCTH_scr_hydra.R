...
win.data <- readRDS("Data/WCTH_windata.rds")

Sst <- readRDS("Data/WCTH_Sst.rds")
z_start <- readRDS("Data/WCTH_z_start.rds")
...
saveRDS(M2,"WCTH_survival_streamline.rds")
saveRDS(M1,"WCTH_survival_streamline_coda.rds")
