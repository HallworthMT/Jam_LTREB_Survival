...
win.data <- readRDS("Data/JAWO_windata.rds")

Sst <- readRDS("Data/JAWO_Sst.rds")
z_start <- readRDS("Data/JAWO_z_start.rds")
...
saveRDS(M2,"JAWO_survival_streamline.rds")
saveRDS(M1,"JAWO_survival_streamline_coda.rds")
