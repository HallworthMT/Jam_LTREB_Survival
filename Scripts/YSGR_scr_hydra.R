...
win.data <- readRDS("Data/YSGR_windata.rds")

Sst <- readRDS("Data/YSGR_Sst.rds")
z_start <- readRDS("Data/YSGR_z_start.rds")
...
saveRDS(M2,"YSGR_survival_streamline.rds")
saveRDS(M1,"YSGR_survival_streamline_coda.rds")
