...
win.data <- readRDS("Data/WEWA_windata.rds")

Sst <- readRDS("Data/WEWA_Sst.rds")
z_start <- readRDS("Data/WEWA_z_start.rds")
...
saveRDS(M2,"WEWA_survival_streamline.rds")
saveRDS(M1,"WEWA_survival_streamline_coda.rds")
