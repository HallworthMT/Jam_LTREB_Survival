...
win.data <- readRDS("Data/JAOR_windata.rds")

Sst <- readRDS("Data/JAOR_Sst.rds")
z_start <- readRDS("Data/JAOR_z_start.rds")
...
saveRDS(M2,"JAOR_survival_streamline.rds")
saveRDS(M1,"JAOR_survival_streamline_coda.rds")
