...
win.data <- readRDS("Data/MAWA_windata.rds")

Sst <- readRDS("Data/MAWA_Sst.rds")
z_start <- readRDS("Data/MAWA_z_start.rds")
...
saveRDS(M2,"MAWA_survival_streamline.rds")
saveRDS(M1,"MAWA_survival_streamline_coda.rds")
