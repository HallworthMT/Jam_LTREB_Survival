...
win.data <- readRDS("Data/JWEV_windata.rds")

Sst <- readRDS("Data/JWEV_Sst.rds")
z_start <- readRDS("Data/JWEV_z_start.rds")
...
saveRDS(M2,"JWEV_survival_streamline.rds")
saveRDS(M1,"JWEV_survival_streamline_coda.rds")
