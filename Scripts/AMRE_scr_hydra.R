...
win.data <- readRDS("Data/AMRE_windata.rds")

Sst <- readRDS("Data/AMRE_Sst.rds")
z_start <- readRDS("Data/AMRE_z_start.rds")
...
saveRDS(M2,"AMRE_survival_streamline.rds")
saveRDS(M1,"AMRE_survival_streamline_coda.rds")
