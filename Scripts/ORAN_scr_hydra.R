...
win.data <- readRDS("Data/ORAN_windata.rds")

Sst <- readRDS("Data/ORAN_Sst.rds")
z_start <- readRDS("Data/ORAN_z_start.rds")
...
saveRDS(M2,"ORAN_survival_streamline.rds")
saveRDS(M1,"ORAN_survival_streamline_coda.rds")
