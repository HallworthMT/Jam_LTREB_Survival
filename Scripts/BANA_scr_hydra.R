...
win.data <- readRDS("Data/BANA_windata.rds")

Sst <- readRDS("Data/BANA_Sst.rds")
z_start <- readRDS("Data/BANA_z_start.rds")
...
saveRDS(M2,"BANA_survival_streamline.rds")
saveRDS(M1,"BANA_survival_streamline_coda.rds")
