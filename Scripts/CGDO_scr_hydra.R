...
win.data <- readRDS("Data/CGDO_windata.rds")

Sst <- readRDS("Data/CGDO_Sst.rds")
z_start <- readRDS("Data/CGDO_z_start.rds")
...
saveRDS(M2,"CGDO_survival_streamline.rds")
saveRDS(M1,"CGDO_survival_streamline_coda.rds")
