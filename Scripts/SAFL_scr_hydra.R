...
win.data <- readRDS("Data/SAFL_windata.rds")

Sst <- readRDS("Data/SAFL_Sst.rds")
z_start <- readRDS("Data/SAFL_z_start.rds")
...
saveRDS(M2,"SAFL_survival_streamline.rds")
saveRDS(M1,"SAFL_survival_streamline_coda.rds")
