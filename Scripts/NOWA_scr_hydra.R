...
win.data <- readRDS("Data/NOWA_windata.rds")

Sst <- readRDS("Data/NOWA_Sst.rds")
z_start <- readRDS("Data/NOWA_z_start.rds")
...
saveRDS(M2,"NOWA_survival_streamline.rds")
saveRDS(M1,"NOWA_survival_streamline_coda.rds")
