...
win.data <- readRDS("Data/YEWA_windata.rds")

Sst <- readRDS("Data/YEWA_Sst.rds")
z_start <- readRDS("Data/YEWA_z_start.rds")
...
saveRDS(M2,"YEWA_survival_streamline.rds")
saveRDS(M1,"YEWA_survival_streamline_coda.rds")
