...
win.data <- readRDS("Data/BAWW_windata.rds")

Sst <- readRDS("Data/BAWW_Sst.rds")
z_start <- readRDS("Data/BAWW_z_start.rds")
...
saveRDS(M2,"BAWW_survival_streamline.rds")
saveRDS(M1,"BAWW_survival_streamline_coda.rds")
